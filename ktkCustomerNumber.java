...
/**
   This prgram tests a customer number to 
   verify that is it in the proper format.
*/

public class ktkCustomerNumber
{
   ...
   /**
      This isValid method determins whether a 

...
/**
This prgram asks the user to enter a numeric test
score and displays a letter grade for the score. The program
uses and if-else-if statement to determine the letter grade.
*/
...
str = str + "the weather looks great \n";

str = str + "have a nice day.";
